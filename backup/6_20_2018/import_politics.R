...
primaries.d.cnty = dcast(primaries.d,statefipsn+cntyfipsn~candidate,value.var=c('votes','totvote','votepct'))
primaries.r.cnty = dcast(primaries.r,statefipsn+cntyfipsn~candidate,value.var=c('votes','totvote','votepct'))
...
save(primaries,primaries.cnty,primaries.d.cnty,primaries.r.cnty,file=path)
