...
cces[, cc.vote12 := 0]
cces[is.na(cc.CC16_326), cc.vote12 := NA]
cces[cc.GEVote == 7 | cc.GEVote >= 9, cc.vote12 := NA]
cces[cc.GEVote == 1, cc.vote12 := 1]
cces[cc.GEVote == 2, cc.vote12 := 2]
cces[cc.GEVote == 3, cc.vote12 := 3]
cces[cc.GEVote == 4, cc.vote12 := 4]
cces[cc.GEVote == 8, cc.vote12 := 5]
cces[cc.GEVote == 5, cc.vote12 := 6]
cces[cc.GEVote == 6, cc.vote12 := 0]
factor(cces$cc.vote16, labels = c('Did not vote', 'Donald Trump', 'Hillary Clinton', 'Gary Johnson', 'Jill Stein', 'Evan McMullin', 'Other'))
