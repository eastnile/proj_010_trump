...
for (year in c(2008,2012,2016)) {
   genelec[,paste('dr.ratio.',year,sep='') := get(paste('gop_',year,sep=''))/get(paste('dem_',year,sep=''))]
   genelec[,paste('dr.marg.',year,sep='') := get(paste('gop_',year,sep=''))-get(paste('dem_',year,sep=''))]
   genelec[,paste('dr.pmarg.',year,sep='') := (get(paste('gop_',year,sep=''))-get(paste('dem_',year,sep='')))
