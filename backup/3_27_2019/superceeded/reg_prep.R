...
# To do:
# Remove starred variables with a warning 
# Figure out how to do OLS, probit etc with weights
# Streamline regression output
# Explore data


#
gsdat = data.table(gs_read(codebook.gs,ws='cces codebook'))
